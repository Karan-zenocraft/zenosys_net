     ...
     <div class="row CustomeRows">
       ...
       <div class="col-md-4 WhyZenosysContent WhyZenosysContentCustome">
          <img src="<?php echo base_url(); ?>assets/images/staffing1.png" class="img-fluid CommanImg" style="right:20px;max-width:87%;top:0px;">
           ...
           <img src="<?php echo base_url(); ?>assets/images/staffing2.png" class="img-fluid CommanImg" style="max-width:80%;left:0px;">
       ...
       <div class="col-md-4 WhyZenosysContent WhyZenosysContentCustome">
          <img src="<?php echo base_url(); ?>assets/images/staffing3.png" class="img-fluid CommanImg" style="max-width:60%;right:75px;" >
                   ...
                   <div class="row CustomeRows">
                <div class="col-md-4 WhyZenosysContent WhyZenosysContentCustome">
<img src="<?php echo base_url(); ?>assets/images/MSP.png" class="img-fluid CommanImg" style="left:0;max-width:93%;">
