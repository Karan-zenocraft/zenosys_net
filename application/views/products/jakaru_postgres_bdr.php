    ...
    .WhyZenosys .WhyZenosysContent h2:before{content: unset;}
                ...
                <div class="col-md-8 WhyZenosysContent">
                    ...
                    <h2 class="TitleH2">Jakaru Postgres BDR</h2>
                     <p class="TitleP">Jakaru BDR is bi-directional replication system developed for Postgres Databases that support enterprise configuration of Postgres databases in a master-master setup or a master-slave setup. With Jakaru designed to support any number of nodes to participate in this replication-system, enterprises can leverage nodes within the cluster for read-only or zone-specific configuration.</p>
            ...
            <img src="<?php echo base_url(); ?>assets/images/JAKARU-POSTGRES-BDR.png" class="img-fluid CommanImg GovernmentImg fullwidth fullwidth2 Retail Telecommunication">
        </div>
            </div>
