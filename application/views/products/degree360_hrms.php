...
<style>
    ...
    .WhyZenosys .WhyZenosysContent h2:before{content: unset;}
                ...
                <div class="col-md-8 WhyZenosysContent">
                   ...
                   <p class="TitleP">Cloud Based Degree360 is a comprehensive HRMS solution for large organizations with locations spanning countries/continents with varying set of rules to conform to. Enterprise can choose the modules to activate - Time office management,  Payroll processing, Personal , Recruitment and Performance management,Leave management, Employee Facility management, Employee appraisal , Employee Training plan, while the decoupled-modules within the application allow for easy enabling/disabling of interface-transactions.</p>
            ...
            <img src="<?php echo base_url(); ?>assets/images/360 hrms.jpg" class="img-fluid CommanImg GovernmentImg fullwidth fullwidth2 Retail Telecommunication">
        </div>
            </div>
